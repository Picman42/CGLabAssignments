...
// ===================================================================
// NEW: DETS
float Matrix::Det2() const
{
  float a1, a2, b1, b2;
  a1 = data[0][0]; b1 = data[0][1];
  a2 = data[1][0]; b2 = data[1][1];
  return det2x2(a1, b1, a2, b2);
}

float Matrix::Det3() const
{
  float a1, a2, a3, b1, b2, b3, c1, c2, c3;
  a1 = data[0][0]; b1 = data[0][1]; c1 = data[0][2];
  a2 = data[1][0]; b2 = data[1][1]; c2 = data[1][2];
  a3 = data[2][0]; b3 = data[2][1]; c3 = data[2][2];
  return det3x3(
    a1, b1, c1,
    a2, b2, c2,
    a3, b3, c3
